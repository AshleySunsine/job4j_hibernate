...
@Entity
@Table(name = "candidatessssss")
public class Candidateee {
    @Id
    ...
    @OneToOne
    private Vacansion vac;

    public Candidateee() {
    }

    public Candidateee(String name, String experience, long salary) {
    ...
    public boolean equals(Object o) {
        ...
        Candidateee candidate = (Candidateee) o;
